									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">{{ $setting->map }}</p>
											</li>
											<li>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											<li><a href="{{ $setting->twitter }}" class="link-to-item" title="twitter" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
											...
											<li><a href="{{ $setting->pinterest }}" class="link-to-item" title="pinterest" target="_blank"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
