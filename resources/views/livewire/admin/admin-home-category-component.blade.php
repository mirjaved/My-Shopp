<div>
    <div class="container" padding="30px 0">
        <div class="row">
                    ...
                    <form class="form-horizontal" wire:submit.prevent="updateHomeCategory">
                        <div class="form-group">
                            ...
                            <div class="col-md-4" wire:ignore>
                                <select name="categories[]" id="categories" class="sel_categories form-control" multiple="multiple" wire:model="selected_categories">
