				...
				<form wire:submit.prevent="placeOrder">
					<div class="row">
							...
							<div class="wrap-address-billing">
								...
								<div class="billing-address">
									...
									<p class="row-in-form">
										...
										<input type="text" name="line1" value="" placeholder="Street at apartment number 2" wire:model="line2">
									</p>
									<p class="row-in-form">
						...
						@if($ship_to_different)
							<div class="col-md-12">
								<div class="wrap-address-billing">
									<h3 class="box-title">Shpping Address</h3>
									<div class="billing-address">
										<p class="row-in-form">
											<label for="fname">first name<span>*</span></label>
										...
										<p class="row-in-form">
											...
											<input type="number" name="s_phone" value="" placeholder="10 digits format" wire:model="s_mobile">
											@error('s_mobile')
												<p class="text-danger">{{ $message }}</p>
											@enderror
										</p>
										...
										<p class="row-in-form">
											<label for="add">Line 2:</label>
											<input type="text" name="line2" value="" placeholder="Street at apartment number 2" wire:model="s_line2">
											@error('s_line2')
												<p class="text-danger">{{ $message }}</p>
											@enderror
										</p>
						...
						<div class="summary-item payment-method">
							...
							@if($paymentMode == 'card')
								<div class="wrap-address-billing">
									...
									@endif
									<p class="row-in-form">
										<label for="card-number">PosCard Number:</label>
