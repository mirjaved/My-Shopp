							...
							<div class="tab-content-item active" id="digital_1a">
								<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
									...
									@foreach ($lastestProducts as $lastestProduct)
										<div class="product product-style-2 equal-elem ">
											<div class="product-thumnail">
												<a href="{{ route('product.details', ['slug' => $lastestProduct->slug]) }}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
													<figure><img src="{{ asset('assets/images/products/') }}/{{ $lastestProduct->image }}" width="800" height="800" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
												</a>
												<div class="group-flash">
											...
											<div class="product-info">
												<a href="{{ route('product.details', ['slug' => $lastestProduct->slug]) }}" class="product-name"><span>{{ $lastestProduct->name }}</span></a>
												<div class="wrap-price"><span class="product-price">${{ $lastestProduct->regular_price }}</span></div>
											</div>
										</div>
									@endforeach
								</div>
