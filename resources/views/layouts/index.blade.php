...
<body class="home-page home-01 ">
										...
										@if(Auth::user()->user_type === "ADM")
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a href="{{ route('admin.sale') }}" title="sale">Sale settings</a>
													</li>
													<li class="menu-item">
														<a href="{{ route('admin.homecategories') }}" title="Mange Home Categories">Mange Home Categories</a>
													</li>
													<li class="menu-item">
	...
	<script src="https://cdn.tiny.cloud/1/c0capgscdctqqn9943g8uuh3vaen9faear354f7g4d807mzr/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
	@livewireScripts
	@stack('scripts')
</body>
</html>